...
namespace VehicleAPI.Controllers
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        [HttpGet("GetById")]
        public async Task<ActionResult<VehicleRegistration>> GetById(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> PutVehicle(Guid id,VehicleRegistration vehicleRegistration)
        {
            await _vehicleService.UpdateVehicle(id,vehicleRegistration);
            return NoContent();
        }
